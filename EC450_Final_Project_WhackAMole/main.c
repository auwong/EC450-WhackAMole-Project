...
volatile unsigned int tones [] = {5000,7000};
...
volatile unsigned int game_over = 0;
volatile unsigned int new_high_score = 0;
volatile unsigned int temp_score = 0;
...
void eraseD()
{ // erase information memory segment D
...
unsigned random_gen(void)
{
	...
	//unsigned old_TA0CTL = TA0CTL;
	unsigned old_TA0CCTL0 = TA0CCTL0;
	//unsigned old_TA0CCR0 = TA0CCR0;
